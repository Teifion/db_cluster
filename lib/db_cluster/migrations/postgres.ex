defmodule DBCluster.Migrations.Postgres do
  @moduledoc false
  # Copied and modified from Oban

  @behaviour DBCluster.Migration
  ...
  def migrated_version(opts) do
    ...
    WHERE pg_class.relname = 'setting_site'
  ...
  defp record_version(%{prefix: prefix}, version) do
    execute("COMMENT ON TABLE #{inspect(prefix)}.db_cluster_members IS '#{version}'")
  end
